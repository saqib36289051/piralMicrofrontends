...
function overview(server) {
    return (req, res) => {
        res.json({
            requests: (0, helpers_1.mapReverse)(server.recorder.requests, convertRequest),
            errors: (0, helpers_1.mapReverse)(server.recorder.errors, convertMiss),
            messages: (0, helpers_1.mapReverse)(server.recorder.messages, convertMessage),
        });
    };
}
