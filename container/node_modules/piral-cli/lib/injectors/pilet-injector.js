...
async function loadFeed(feed, headers) {
    try {
        const response = await external_1.axios.default.get(feed, { headers });
...
class PiletInjector {
    ...
    download(path) {
        ...
        return external_1.axios.default.get(url.href, { ...opts, responseType: 'arraybuffer' });
    }
